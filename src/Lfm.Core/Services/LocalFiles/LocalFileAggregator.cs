...
public class LocalFileAggregator
{
    ...
    /// </summary>
    public List<ArtistInfo> AggregateTopArtists(List<PlayEvent> events, int? limit = null)
    {
    ...
    /// </summary>
    public List<TrackInfo> AggregateTopTracks(List<PlayEvent> events, int? limit = null)
    {
    ...
    /// </summary>
    public List<AlbumInfo> AggregateTopAlbums(List<PlayEvent> events, int? limit = null)
    {
    ...
    /// </summary>
    public List<TrackInfo> GetArtistTracks(List<PlayEvent> events, string artistName)
    {
    ...
    /// </summary>
    public List<AlbumInfo> GetArtistAlbums(List<PlayEvent> events, string artistName)
    {
        var artistEvents = events
            .Where(e => e.Artist.Equals(artistName, StringComparison.OrdinalIgnoreCase))
            .ToList();
    ...
    /// </summary>
    public List<TrackInfo> GetAlbumTracks(List<PlayEvent> events, string artistName, string albumName)
    {
    ...
    /// </summary>
    public List<TrackInfo> GetRecentTracks(List<PlayEvent> events, int limit = 50)
    {
        return events
