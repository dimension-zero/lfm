...
public interface IMusicDataProvider
{
    ...
    Task<Result<TopArtists>> GetTopArtistsAsync(string username, string period = "overall", int limit = 10, int page = 1);
    Task<Result<TopTracks>> GetTopTracksAsync(string username, string period = "overall", int limit = 10, int page = 1);
    Task<Result<TopAlbums>> GetTopAlbumsAsync(string username, string period = "overall", int limit = 10, int page = 1);
